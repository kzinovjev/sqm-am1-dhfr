 ...
 !Notes for elec eng: IOS = 1, IOP = 0, GSSC = 0, GPPC = 0, GSPC = 0, GP2C = 0, HSP = 0
  ...
  !AM1/DHFR
   ! Reference: Doron et al. J. Chem. Theory Comput. 2011, 7, 3420–3437
     ...
     s_orb_exp_am1dhfr(atomic_number) = 1.24851395D0
     p_orb_exp_am1dhfr(atomic_number) = 0.0d0
     betas_am1dhfr(atomic_number) = -6.33105768D0
     betap_am1dhfr(atomic_number) = 0.0d0
     FN1_am1dhfr(1,atomic_number) = 0.10477938D0
     FN2_am1dhfr(1,atomic_number) = 5.11512463D0
     FN3_am1dhfr(1,atomic_number) = 1.15101043D0
     FN1_am1dhfr(2,atomic_number) = -0.01289865D0
     FN2_am1dhfr(2,atomic_number) = 5.18465935D0
     FN3_am1dhfr(2,atomic_number) = 1.75423483D0
     FN1_am1dhfr(3,atomic_number) =-0.01178407D0
     FN2_am1dhfr(3,atomic_number) = 1.98528456D0
     FN3_am1dhfr(3,atomic_number) = 2.19234758D0
     ...
     GSS_am1dhfr(atomic_number) = 12.84709466D0
     alp_am1dhfr(atomic_number) = 2.98632722D0
     USS_am1dhfr(atomic_number) = -10.68984024D0
 ...
 !Notes for elec eng: IOS = 2, IOP = 2, GSSC = 1, GPPC = -0.5, GSPC = 4, GP2C = 1.5, HSP = -2
  ...
  !AM1/DHFR
   ! Reference: Doron et al. J. Chem. Theory Comput. 2011, 7, 3420–3437
     am1dhfr_ref_index(atomic_number) = 105
     element_supported_am1dhfr(atomic_number) = .true.
     s_orb_exp_am1dhfr(atomic_number) = 1.83025672D0
     p_orb_exp_am1dhfr(atomic_number) = 1.69607884D0
     betas_am1dhfr(atomic_number) = -15.72667726D0
     betap_am1dhfr(atomic_number) = -7.80162672D0
     FN1_am1dhfr(1,atomic_number) = 0.00301604D0
     FN2_am1dhfr(1,atomic_number) = 4.94955509D0
     FN3_am1dhfr(1,atomic_number) = 1.58636330D0
     FN1_am1dhfr(2,atomic_number) = 0.05629335D0
     FN2_am1dhfr(2,atomic_number) = 5.04827121D0
     FN3_am1dhfr(2,atomic_number) = 1.87582178D0
     FN1_am1dhfr(3,atomic_number) =-0.02474245D0
     FN2_am1dhfr(3,atomic_number) = 5.00959715D0
     FN3_am1dhfr(3,atomic_number) = 2.02202225D0
     FN1_am1dhfr(4,atomic_number) =-0.00722588D0
     FN2_am1dhfr(4,atomic_number) = 5.13550628D0
     FN3_am1dhfr(4,atomic_number) = 2.68246146D0
     NUM_FN_am1dhfr(atomic_number) = 4
     GSS_am1dhfr(atomic_number) = 12.17894654D0
     GSP_am1dhfr(atomic_number) = 11.42197994D0
     GPP_am1dhfr(atomic_number) = 11.28414421D0
     GP2_am1dhfr(atomic_number) = 9.87970858D0
     HSP_am1dhfr(atomic_number) = 2.40762387D0
     alp_am1dhfr(atomic_number) = 2.64566311D0
     USS_am1dhfr(atomic_number) = -52.24737422D0
     UPP_am1dhfr(atomic_number) = -38.46838755D0
  !AM1D
   ! Reference:  M.J.S. DEWAR ET AL, J. AM. CHEM. SOC. 107 3902-3909 (1985) (index = 17)
 ...
 !Notes for elec eng: IOS = 2, IOP = 3, GSSC = 1, GPPC = -1.5, GSPC = 6, GP2C = 4.5, HSP = -3
  ...
  !AM1/DHFR
   ! Reference: Doron et al. J. Chem. Theory Comput. 2011, 7, 3420–3437
     am1dhfr_ref_index(atomic_number) = 105
     element_supported_am1dhfr(atomic_number) = .true.
     s_orb_exp_am1dhfr(atomic_number) = 2.45754818D0
     p_orb_exp_am1dhfr(atomic_number) = 2.29720493D0
     betas_am1dhfr(atomic_number) = -19.14256652D0
     betap_am1dhfr(atomic_number) = -19.28044417D0
     FN1_am1dhfr(1,atomic_number) = 0.01584487D0
     FN2_am1dhfr(1,atomic_number) = 5.01639898D0
     FN3_am1dhfr(1,atomic_number) = 1.40990729D0
     FN1_am1dhfr(2,atomic_number) = 0.02413205D0
     FN2_am1dhfr(2,atomic_number) = 4.95264284D0
     FN3_am1dhfr(2,atomic_number) = 2.08955372D0
     FN1_am1dhfr(3,atomic_number) = 0.00231665D0
     FN2_am1dhfr(3,atomic_number) = 2.02251051D0
     FN3_am1dhfr(3,atomic_number) = 2.53289116D0
     FN1_am1dhfr(4,atomic_number) = 0.0000000D0
     FN2_am1dhfr(4,atomic_number) = 0.0000000D0
     FN3_am1dhfr(4,atomic_number) = 0.0000000D0
     NUM_FN_am1dhfr(atomic_number) = 3
     GSS_am1dhfr(atomic_number) = 13.65461868D0
     GSP_am1dhfr(atomic_number) = 12.79898733D0
     GPP_am1dhfr(atomic_number) = 12.88438212D0
     GP2_am1dhfr(atomic_number) = 11.47612859D0
     HSP_am1dhfr(atomic_number) = 3.18707623D0
     alp_am1dhfr(atomic_number) = 3.11091376D0
     USS_am1dhfr(atomic_number) = -72.82069585D0
     UPP_am1dhfr(atomic_number) = -59.49215630D0
 ...
 !Notes for elec eng: IOS = 2, IOP = 4, GSSC = 1, GPPC = -0.5, GSPC = 8, GP2C = 6.5, HSP = -4
  ...
  !AM1/DHFR
   ! Reference: Doron et al. J. Chem. Theory Comput. 2011, 7, 3420–3437
     am1dhfr_ref_index(atomic_number) = 105
     element_supported_am1dhfr(atomic_number) = .true.
     s_orb_exp_am1dhfr(atomic_number) = 3.11536491D0
     p_orb_exp_am1dhfr(atomic_number) = 2.49978900D0
     betas_am1dhfr(atomic_number) = -29.03471808D0
     betap_am1dhfr(atomic_number) = -28.97637174D0
     FN1_am1dhfr(1,atomic_number) = 0.28934086D0
     FN2_am1dhfr(1,atomic_number) = 4.98540050D0
     FN3_am1dhfr(1,atomic_number) = 0.83276255D0
     FN1_am1dhfr(2,atomic_number) = 0.07785336D0
     FN2_am1dhfr(2,atomic_number) = 7.01317050D0
     FN3_am1dhfr(2,atomic_number) = 1.42486880D0
     ...
     GSS_am1dhfr(atomic_number) = 15.58420000D0
     GSP_am1dhfr(atomic_number) = 14.53118414D0
     GPP_am1dhfr(atomic_number) = 14.52057396D0
     GP2_am1dhfr(atomic_number) = 13.09474870D0
     HSP_am1dhfr(atomic_number) = 3.98430700D0
     alp_am1dhfr(atomic_number) = 4.45864569D0
     USS_am1dhfr(atomic_number) = -97.18740347D0
     UPP_am1dhfr(atomic_number) = -78.15419188D0
